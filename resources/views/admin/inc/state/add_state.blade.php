                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <button class="btn btn-primary" data-toggle="collapse" data-target="#state_box">+
                                        Add</button>
                                </div>

                                <!-- Card Body -->
                                <div class="card-body collapse" id="state_box">
                                    <form action="{{ url(env('ADMIN_DIR') . '/state/add') }}" method="POST"
                        ...
                        <div class="col-xs-12 col-lg-12">
                            <form action="{{ url(env('ADMIN_DIR') . '/add-state/delete/all') }}" method="POST">
                                @csrf
                                <div class="card">
                                    <div class="card-header d-sm-flex align-items-center justify-content-between mb-4">
                                        ...
                                        <button type="submit"
                                            ...
                                            data-url="{{ url(env('ADMIN_DIR') . '/add-state/delete/all') }}"
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($lists as $list)
                                                    <tr class="bg-light">
                                                        ...
                                                        <td>
                                                            <a
                                                                href="{{ url(env('ADMIN_DIR') . '/state/edit/' . $list->id) }}">
