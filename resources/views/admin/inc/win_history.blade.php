                            ...
                            <div class="col-xs-12 col-lg-12">
                                <div class="card">
                                    <div class="card-header d-sm-flex align-items-center justify-content-between mb-4">
                                        <h6 class="m-0 font-weight-bold text-primary">Win History</h6>
                                        <div class="">
                                            ...
                                            <tbody>
                                                @foreach ($win as $key => $list)
                                                    <tr class="bg-light">
                                                        ...
                                                        <td>{{ $list->timeslot_id ? $list->timeslot_id : '' }}</td>
                                                        <td>{{ $list->game ? $list->game->name : '' }}</td>
                                                        <td>
                                                            <img src="{{ url('imgs/game/' . $list->game->image) }}"
                                                                alt="" width="50">
                                                        </td>
                                                        <td>{{ $list->game ? $list->game->type : '' }}</td>
                                                        <td>
                                                            {{ $list->date }}
                                                        </td>
                                                    </tr>
